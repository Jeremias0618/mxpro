         ...
         <div class="metabox">
           ...
           <span class="meta-i">
            ...
            <a href="javascript:void(0)" id="fullscreen"><?php echo TXT_FULLSCREEN; ?></a>
                     ...
                     <a href="filme.php?sessao=<?php echo $_GET['sessao']; ?>&stream=<?php echo $_GET['stream']; ?>&streamtipo=<?php echo $_GET['streamtipo']; ?>&player=2" class="btn <?php if($_GET['player'] == 2 || $_GET['player'] == '') { echo 'btn-primary'; } ?>">PLAYER 1</a>
